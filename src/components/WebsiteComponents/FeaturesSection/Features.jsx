...
// import FeaturesBg from '/playground-sample.png';
// import FeaturesElement from '/playground-sample.png';
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="text-3xl font-bold mb-4">3 simple steps.</h1>
            <p className="text-xl text-slate-300">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat.</p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-slate-300">Take collaboration to the next level with security and administrative features built for teams.</div>
                  </div>
            ...
            {/* Tabs items */}
            <div className="p-4 max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-7 mb-8 md:mb-0 md:order-1" data-aos="zoom-y-out" ref={tabs}>
              <div className="relative h-full flex flex-col items-center justify-center text-center p-4 lg:text-right">
                {/* Item 1 */}
                <Transition
                  show={tab === 1}
                  appear={true}
