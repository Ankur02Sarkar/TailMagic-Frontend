...
export default function EmptyState() {
    return (
      ...
      >
        ...
        <span className="mt-2 inline-block text-md font-medium text-slate-300">No component to display yet</span>
        <span className="mt-2 inline-block text-sm font-medium text-slate-300">Get started - Enter a prompt to witness the magic</span>
