      ...
      <div className="max-w-2xl mx-auto py-2 px-6 lg:max-w-7xl">
            ...
            <div>
              <div className="pb-2">
                <span className="flex flex-row">
                    ...
                    <span className="">
                        <h2 className="text-xl font-bold text-slate-300 px-2">Create your component</h2>
                        <p className="text-sm py-2 px-2 font-medium text-slate-300">
                            Enter a prompt describing the component you want TailMagic to generate. Make sure to include your preferred colour scheme and the theme of the component (eg. e-commerce, food, finance) for best results.
                        </p>
                    </span>
                </span>
        ...
        <div className="relative mt-1">
              ...
              {availableComponents.map((availableComponent, availableComponentIdx) => (
                <Listbox.Option
                  ...
                  className={({ active }) =>
                    `relative cursor-default select-none py-2 pl-10 pr-4 ${
                      active ? 'bg-teal-100 text-slate-300 font-semibold' : 'text-slate-300'
                    }`
                  }
                ...
                <div className="sm:col-span-2 pb-2">
                  ...
                  <div className="mt-2">
                    <textarea
                      name="prompt"
                      id="prompt"
                      className="placeholder:text-slate-300 block w-full px-2 h-24 border-2 border-gray-200 rounded-md shadow-sm focus:ring-teal-300 focus:border-teal-300 sm:text-sm"
                ...
                <div className="sm:col-span-2">
                    ...
                    <fieldset className="border-t border-slate-300">
                        <legend className="mx-auto px-4 block text-sm text-center font-medium text-slate-300">OR</legend>
                    </fieldset>
                  ...
                  <div className="mt-2 grid grid-rows-2 gap-y-4">
                    <div className="bg-slate-100 rounded-sm text-sm text-center text-slate-300 font-semibold px-2 py-3 w-full">
          ...
          <div className="mt-8 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                <button
                  type="submit"
                  className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-teal-400 text-base font-medium text-slate-300 hover:bg-teal-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-300 sm:col-start-2 sm:text-sm"
                  onClick={() => {
                ...
                <button
                  type="button"
                  className="w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-slate-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-300 sm:mt-0 sm:col-start-1 sm:text-sm"
