      ...
      <header className="playground-header font-bold text-2xl py-4 px-6 flex items-center justify-between row-span-1">
        ...
        <div className="flex flex-row items-center justify-end">
          {/* <div>
            <button
              type="button"
              className="inline-block rounded-lg px-3 py-2 text-sm font-semibold leading-6 text-slate-300 bg-gray-800 shadow-md ring-1 ring-gray-900/10 hover:ring-gray-900/20"
        ...
        />
          <div className="p-6 w-full h-full">
              <PlaygroundEditor
                ...
                componentRequested={componentRequested}
               />
            {/* <CodeBracketIcon className="h-8 w-8 text-slate-300 bg-gray-800 p-2 my-3 rounded-lg font-bold"/> */}
