  ...
  useEffect(()=>{
    ...
    return(
        ...
        <div className="h-full" id="playground-editor">
          ...
          <button
              type="button"
              className="inline-block mr-4 rounded-lg px-3 py-2 text-sm font-semibold leading-6 text-slate-300 bg-gray-800 shadow-md ring-1 ring-gray-900/10 hover:ring-gray-900/20"
              onClick={()=>{setShowModalForm(true)}}
          >
                Create New Component
          
              <PlusCircleIcon className="h-5 w-5 ml-1.5 mb-0.5 inline-block text-slate-300 font-bold"/>
        
          </button>
          <button 
            type="button"
            onClick={()=>{setOpenCodeEditor(!openCodeEditor);}}
            className="my-4 inline-block rounded-lg px-3 py-2 text-sm font-semibold leading-6 text-slate-300 bg-gray-800 shadow-md ring-1 ring-gray-900/10 hover:ring-gray-900/20"
          >
            {openCodeEditor 
