          ...
          <nav className="flex h-9 items-center justify-between" aria-label="Global">
            <div className="flex lg:min-w-0 lg:flex-auto" aria-label="Global">
              <a href="#" className="-m-1.5 p-1.5">
                {/* <img src='icon.png' className='h-6 w-6 rounded-sm inline-block mr-4 mb-1'/> */}
                <span className="font-black text-2xl tracking-wide inline-block">TailMagic</span>
              </a>
            </div>
            ...
            <div className="hidden lg:flex lg:min-w-0 lg:flex-auto lg:justify-center lg:gap-x-12">
              {navigation.map((item) => (
                <a key={item.name} href={item.href} className="font-semibold text-slate-300 hover:underline hover:underline-offset-8 hover:decoration-teal-300 hover:decoration-2">
                  {item.name}
                </a>
              ))}
            </div>
            <div className="hidden lg:flex lg:min-w-0 lg:flex-auto lg:justify-end">
              ...
              >
                Try It Now
                <span className="px-1 text-slate-300 font-bold" aria-hidden="true">
                  &rarr;
                </span>
              </a>
            </div>
                  ...
                  <div className="space-y-2 py-6">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-slate-300 hover:bg-gray-300/10 hover:text-teal-400"
                      >
                        {item.name}
                      </a>
                    ))}
